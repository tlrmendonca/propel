...
import propel.evaluator.egraph.mutable.simple.{EGraph, EGraphOps, Op, Type}
...
/**
  ...
  */
class IdAnalysis(varList: MutableHashMap[String, Type] = MutableHashMap()) extends Analysis {
  /**
